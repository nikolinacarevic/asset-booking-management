...
public class MainStressSimulation extends Simulation {
    ...
    {
        setUp(
                usersScenario.injectOpen(rampUsers(100).during(30)),
                assetsScenario.injectOpen(rampUsers(150).during(30)),
                assetCategoriesScenario.injectOpen(rampUsers(50).during(30)),
                bookingsScenario.injectOpen(rampUsers(100).during(30)),
                reportsScenario.injectOpen(rampUsers(25).during(30))
        )
